...
function PendingPurchaseDetails() {
    ...
    var partyUrl = "http://103.197.121.188:85/api/values/GetMasterData?MasterType=3&Comp=comp0015&FY=2021";
    ...
    const sendRequest = React.useCallback(async () => {
        ...
        try {
            var GetPODetails = "http://localhost:16067/api/GetPendingPurchaseOrderDetails"
            ...
            await fetch(GetPODetails + '?' + params.join('&')).then(res => res.json()).then(result => {
    ...
    return (
        ...
        <div className="container col-sm-12" style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "bottom", margin: "0 auto;" }}>
            ...
            <div className="card-title">
                <span style={{ fontSize: "20px" }}>Pending Purchase Details</span>
            </div>
            {/*Custom Data List*/}
                ...
                showResults ?
                    ...
                    <>
                        <div className="col-12" style={{ textAlign: 'center', backgroundColor: '#8389d4', margin: '0', padding: '0' }}>
                            <span className="card-title" style={{ fontSize: '15px', color: 'white', fontWeight: 900, margin: '0', padding: '0' }}>Pending Purchase Details Report</span>
                        </div>
                                        ...
                                        <thead className="thead-light table-secondary">
                                            <tr>
                                                ...
                                                <th style={{ padding: "10px 20px" }} scope="col"><span>Value</span></th>
                                                  {/*GrQty*/}
                                                <th style={{ padding: "10px 20px" }} scope="col"><span>Recieve Qty.</span></th>
                                                <th style={{ padding: "10px 20px" }} scope="col"><span>Pending Qty.</span></th>
                                                <th style={{ padding: "10px 27px" }} scope="col"><span>Deliever Date</span></th>
                                                <th style={{ padding: "10px 20px" }} scope="col"><span>Open Close</span></th>

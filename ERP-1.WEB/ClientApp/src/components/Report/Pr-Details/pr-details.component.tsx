...
function prDetails() {
    ...
    var seriesUrl = "http://103.197.121.188:85/api/values/GetSeries?User=aa&TranType=43&Comp=comp0015&FY=2021";
    //------------ default date block-----------------------------------------------------------------------------------------------------------------------
    ...
    const sendRequest = React.useCallback(async () => {
        ...
        try {
            var GetPrDetails = "http://localhost:16067/api/GetPrDetails"
      ...
      <div  style={{ margin: '10px -8em 0 -8em', }}>
        <div className="container col-sm-12" style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "bottom", margin: "0 auto;" }}>
            ...
            <div className="card-title">
                <span style={{ fontSize: "20px" }}>Pr Details</span>
            </div>
            {/*Custom Data List*/}

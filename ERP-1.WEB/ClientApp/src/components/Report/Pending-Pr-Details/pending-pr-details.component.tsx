...
function PendingPrDetails() {
    ...
    const sendRequest = React.useCallback(async () => {
        ...
        try {
            var GetPrDetails = `http://${window.location.host}/api/GetPendingPrDetails`
        ...
        <div className="firstDiv">
            <div className="container col-sm-12 card" style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "bottom", margin: "0 auto" }}>
                <div className="card-title col-12 text-center" style={{ margin: '0 auto' }}>
                    <span style={{ fontSize: "20px" }}>Pending PR Details</span>
                </div>
                ...
                showResults ?
                    <>
                        ...
                        <div className="col-12" style={{ textAlign: 'center', backgroundColor: '#8389d4', margin: '0', padding: '0' }}>
                            <span className="card-title" style={{ fontSize: '15px', color: 'white', fontWeight: 900, margin: '0', padding: '0' }}>Pending PR Details Report</span>
                        </div>
...
export default PendingPrDetails;
                        ...
                        <ExcelExport data={dataArray} ref={_export}>
                            ...
                            <div style={{ display: 'none', border: '3px solid green' }}>
                                <Grid data={dataArray} style={{ height: "420px" }}>
                                    ...
                                    <GridColumn field="itemGroup" title="Item Group" />
                                    ...
                                    <GridColumn field="approvedOn" title="Approved On" />
                            ...
                            <div className="card col-sm-12" style={{ padding: '0' }}>
                                ...
                                <div className="table-responsive col-12 resp-tab">
                                    ...
                                    <tr>
                                        ...
                                        <th  style={{ padding: "0", margin: '0', backgroundColor:'grey', position: 'sticky'}}  scope="col"><span style={{ margin: '33px', fontWeight: 400, fontSize: '15px', color: 'white' }}>Item.Group</span></th>
                                        ...
                                        <th  style={{ padding: "0", margin: '0', backgroundColor:'grey', position: 'sticky'}}  scope="col"><span style={{ margin: '33px', fontWeight: 400, fontSize: '15px', color: 'white' }}>CreatedBy</span></th>
                                        ...
                                        <th  style={{ padding: "0", margin: '0', backgroundColor:'grey', position: 'sticky'}}  scope="col"><span style={{ margin: '33px', fontWeight: 400, fontSize: '15px', color: 'white' }}>LastApproved</span></th>

...
function Details() {
    ...
    const sendRequest = React.useCallback(async () => {
        ...
        try {
            var GetStockDetails = "http://localhost:16067/api/GetStockDetailsReport"
            ...
            await fetch(GetStockDetails + '?' + params.join('&')).then(res => res.json()).then(result => {
                                    ...
                                    <table className="table table-striped table-bordered table-hover table-sm">
                                        <thead className="thead-light table-secondary">
                                            <tr>
                                                ...
                                                <th scope="col"><span>Material Center</span></th>
                                                <th scope="col"><span>Opn Qty</span></th>
                                                <th scope="col"><span>In Qty</span></th>
                                                <th scope="col"><span>Out Qty</span></th>
                                                <th scope="col"><span>Cls. Qty</span></th>

...
export default function BOMModals_layer2({isItemCostDet, setItemCostDet, ...props }: any) {
    let subtitle: any;
                    ...
                    <div className="collapse show m-1" id="genDetails">
                        <span className="d-flex section2 col-sm-12">
                            <>
                                ...
                                <input type="text" name="series" className="form-control inp col-7" />
                            </>
                        ...
                        <span className="d-flex section2 col-sm-12">
                            <>
                                ...
                                <input type="text" name="payTerm" className="form-control inp col-7" />
                            </>

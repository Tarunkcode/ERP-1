...
class SupplierMaster extends React.PureComponent<IProps, IState> {
    ...
    SetCustomerAccountType = (() => {
        ...
        store1.dispatch({ payload: 22, key: "MasterType", type: "AddOnFormData", label: "BankDetail" });
        store1.dispatch({ payload: 22, key: "AccountType", type: "AddOnFormData", label: "AccProductCurrency" });
        store1.dispatch({ payload: 22, key: "MasterType", type: "AddOnFormData", label: "CommercialDetail" });
        store1.dispatch({ payload: 22, key: "AccountType", type: "AddOnFormData", label: "AccountBillByBillDetail" });
        store1.dispatch({ payload: 22, key: "MasterType", type: "AddOnFormData", label: "AccMasterSeries" });
    })()
...
const CMaster = connect(mapStateToProps, mapDispatchToProps)(SupplierMaster);

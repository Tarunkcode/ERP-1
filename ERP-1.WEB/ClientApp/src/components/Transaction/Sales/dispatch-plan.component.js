    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "main card firstDiv" },
            React.createElement("div", { className: "text-center card-title col-12", style: { textAlign: 'start', backgroundColor: '#8389d4' } },
                React.createElement("span", { className: "row-header p-0 m-0" }, "Dispatch Schedule")),
                    ...
                    React.createElement("fieldset", { className: "form-group border p-0" },
                        ...
                        React.createElement("div", { className: "collapse show", id: "genDetails" },
                            React.createElement("span", { className: "d-flex section2 col-sm-10" },
                                ...
                                React.createElement(React.Fragment, null,
                                    React.createElement("label", { htmlFor: "majProd", style: { fontSize: '0.8em' }, className: "form-label labl labl2" }, "Cancel Dispatch"),
                                    React.createElement("input", { type: "checkbox", name: "payTerm", className: "inp" }))),
                            React.createElement("span", { className: "d-flex section2 col-sm-10" },
                                React.createElement(React.Fragment, null,
                                    React.createElement("label", { htmlFor: "majProd", style: { fontSize: '0.8em' }, className: "form-label labl labl2" }, "Vch Date"),
                                    React.createElement("input", { type: "date", name: "payTerm", className: "form-control inp" })),
                                React.createElement(React.Fragment, null,
                                    React.createElement("label", { htmlFor: "series", style: { fontSize: '0.8em' }, className: "form-label labl labl2" }, "Month"),
                                    React.createElement("input", { type: "date", name: "custCode", className: "form-control inp" }))),
                            React.createElement("span", { className: "d-flex section2 col-sm-10" },
                                React.createElement(React.Fragment, null,
                                    React.createElement("label", { htmlFor: "series", style: { fontSize: '0.8em' }, className: "form-label labl labl2" }, "Customer"),
                                    React.createElement("input", { type: "text", name: "custName", className: "form-control inp" })),
                                React.createElement(React.Fragment, null,
                                    React.createElement("label", { htmlFor: "majProd", style: { fontSize: '0.8em' }, className: "form-label unit labl labl2" }, "P.O No."),
                                    React.createElement("input", { type: "text", name: "payTerm", className: "form-control inp" })))))),
                ...
                React.createElement("div", { className: "row card row-content col-sm-12 addSaleForm container container-fluid container-lg mb-3" },
                    React.createElement("div", { className: "card-body col-sm-12 addCustomer container container-fluid container-lg", style: { overflowX: 'auto', overflowY: 'auto' } },
                        React.createElement("div", { style: { display: 'flex', justifyContent: 'center', alignItems: 'center', borderBottom: '1px solid grey', backgroundColor: '#8389d4', margin: '0', padding: '0', width: '100%' } },
                            React.createElement("span", { className: "card-title", style: { fontSize: '15px', margin: '0', padding: '0' } }, "D.S Customer Item Details")),
                        React.createElement("table", { id: "dtHorizontalExample", className: "table table-striped table-bordered table-sm", style: {
                            ...
                            React.createElement("thead", null,
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("th", { className: "text-center", style: { fontWeight: 400, backgroundColor: 'grey', color: 'white' } }, "SO. No."),
                                    React.createElement("th", { className: "text-center", style: { fontWeight: 400, backgroundColor: 'grey', color: 'white' } }, "Cust.Po.No."),
                                    React.createElement("th", { className: "text-center", style: { fontWeight: 400, backgroundColor: 'grey', color: 'white' } }, "PO Date"),
                                    React.createElement("th", { className: "text-center", style: { fontWeight: 400, backgroundColor: 'grey', color: 'white' } }, "Bal.Aty"),
                                    ...
                                    React.createElement("th", { className: "text-center", style: { fontWeight: 400, backgroundColor: 'grey', color: 'white' } }, "Alt.UoM"),
                                    ...
                                    React.createElement("th", { className: "text-center", style: { fontWeight: 400, backgroundColor: 'grey', color: 'white' } }, "Opn.Po."))),
...
exports.default = DispatchPlan;
//# sourceMappingURL=dispatch-plan.component.js.map
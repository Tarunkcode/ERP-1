        ...
        React.createElement("div", { className: "row card row-content col-sm-12 addSaleForm container container-fluid container-lg mb-3" },
            React.createElement("div", { className: "card-body col-sm-12 addCustomer container container-fluid container-lg", style: { overflowX: 'auto', overflowY: 'auto' } },
                React.createElement("div", { style: { display: 'flex', justifyContent: 'center', alignItems: 'center', borderBottom: '1px solid grey', backgroundColor: '#8389d4', margin: '0', padding: '0', width: '100%' } },
                    React.createElement("span", { className: "card-title", style: { fontSize: '15px', margin: '0', padding: '0' } }, "Items To be Produce")),
                React.createElement("table", { id: "dtHorizontalExample", className: "table table-striped table-bordered table-sm", style: {
                        width: "100%"
                    } },
                    React.createElement("thead", null,
                        React.createElement("tr", null,
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "S.No"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Item Name"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Pend Qty"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Quantity"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "UoM"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Rate"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Value"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Material Center"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Po.No."),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "BatchNo"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "PoSrNo"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "QC.Qty"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "PO.Qty"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "GR.Qty"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Tolrance"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Tolrance Qty"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "isParameter"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "isAssortment"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "AssortCol"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "MinSupQty"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Reason"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "TaxableAmt"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "VatPer"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "VatAmt"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "ScghPer"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "ScghAmt"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Tax Type"),
                            React.createElement("th", { className: "text-center", style: { fontWeight: 400, padding: '0 1em', backgroundColor: 'grey', color: 'white' } }, "Final AMt."))),

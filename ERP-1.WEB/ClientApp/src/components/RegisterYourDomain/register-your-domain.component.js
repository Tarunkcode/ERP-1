...
var RegisterDomain = /** @class */ (function (_super) {
    ...
    function RegisterDomain(props) {
        ...
        _this.handleCompCode = function (e) {
            _this.setState({
        ...
        _this.handleRegistration = function (event) {
            ...
            try {
                var url = "http://" + window.location.host + "/api/SaveDomain";
        ...
        _this.handleCompCode = _this.handleCompCode.bind(_this);
        _this.handleFYChange = _this.handleFYChange.bind(_this);
        return _this;
    }
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", null,
                React.createElement("div", { className: "outer-container" },
                    React.createElement("div", { className: "card", style: { backgroundColor: "grey", width: "83%" } },
                        React.createElement("span", { className: "page_Header", style: { fontWeight: 900, color: "white" } }, "Register Your Domain"),
                        React.createElement("img", { src: './assets/erpLogo.png', style: { width: "33%" } }),
                        React.createElement("div", { className: "inner-container" },
                            React.createElement("form", { onSubmit: this.handleRegistration.bind(this) },
                                React.createElement("input", { type: "text", name: "compcode", id: "compcode", className: "form-control input-fields", required: true, placeholder: "Comp### Code", onChange: this.handleCompCode }),

...
function Sidebar(_a) {
    ...
    var theme = React.useContext(ThemeContext_1.ThemeContext).theme;
    ...
    return (React.createElement("nav", { className: "accordion active", id: "sidebar" },
        React.createElement("ul", { className: "list-unstyled components" },
            React.createElement("div", { className: "sidebar-header", style: theme === 'dark' ? { margin: "0", display: "flex", flexDirection: "column", backgroundColor: "white", border: "6px solid #2c3968", padding: "0" } : { margin: "0", display: "flex", flexDirection: "column", backgroundColor: "white", border: "6px solid #798cd4", padding: "0" } },
                React.createElement("img", { src: './assets/erpLogo.png', style: { width: "56vw", borderRadius: "6%", margin: "0" }, className: "img-fluid erp-logo", alt: "LOGO" })),

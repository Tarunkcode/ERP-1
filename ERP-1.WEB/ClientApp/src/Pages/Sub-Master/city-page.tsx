        ...
        <>
            <div className="main card firstDiv">
                <div className="text-center card-title col-12" style={{ textAlign: 'start', backgroundColor: '#8389d4' }}>
                    <span className="row-header p-0 m-0" >City</span>
                </div>
                        ...
                        <div className="row row-content col-sm-12 addSaleForm container container-fluid container-lg">
                            ...
                            <div className="card-body" style={{ margin: '0', padding: '0' }}>
                                ...
                                <span className="d-flex section2 col-sm-12 mb-2">
                                    <>
                                        <label htmlFor="series" style={{ fontSize: '1rem' }} className="form-label labl ml-2 mr-2 labl2">City</label>
                                    </>
                                    <span className="col-4 m-0 p-0" style={{ width: '100%' }}>
                                        <DatalistInput
                                            ...
                                            onSelect={(item: any) => { console.log('id', item.id); }}
                                            items={[{ id: 1, value: 'Ballia' }]}
                                        />
                                    </span>

                                      {/*  <MasterInput2 name="city" label="City" ipTitle="Enter City" ipType="text" classCategory="form-control col-4 inp" />*/}
                                        <span className="col-1 m-0"></span>
                                    </span>

                                    ...
                                    <select name="addresstype" className="form-control str AddressDetail col-3" onChange={handleAddressOptions} >
                                        {
                                            ...
                                            addressType === 1 ? (<option key="Corporate" selected style={{ fontFamily: "trebuc" }} value={1} >Corporate</option>) : (<option key="Corporate" style={{ fontFamily: "trebuc" }} value={1} selected >Corporate</option>)

                                        }
                                        {
                                            addressType === 2 ? (<option key="Plant" style={{ fontFamily: "trebuc" }} selected value={2} >Plant</option>) : (<option key="Plant" style={{ fontFamily: "trebuc" }} value={2} >Plant</option>)
                                        }
                                        {


                                            accountType == 1 ? addressType === 3 ? (<option key="Shipping" selected style={{ fontFamily: "trebuc" }} value={3}>Shipping</option>) : (<option key="Shipping" style={{ fontFamily: "trebuc" }} value={3}>Shipping</option>) : null
                                        }

...
export default function RouteDetails({ isItemBox, setIsItemBox }: any) {
    ...
    const colDef1: any[] = [{ field: 'srno', headerName: "Sr. No.", minWidth: 80, valueGetter: 'node.rowIndex + 1', cellStyle: {paddingLeft:'10px'} },{ field: 'itC', headerName: "Item Code", minWidth: 200 }, { field: 'itN', headerName: "Item Name", minWidth: 400 }, { field: 'rt', headerName: "Rate", minWidth: 200 }, { field: 'consQty', headerName: "Consume Qty.", minWidth: 200 }, , { field: 'uom4cons', headerName: "UOM", minWidth: 200 }, { field: 'prdcQty', headerName: "Produce Quantity", minWidth: 200 }, { field: 'uom4prdc', headerName: "UOM", minWidth: 200 }, { field: 'cst', headerName: "Cost", minWidth: 200 }, {

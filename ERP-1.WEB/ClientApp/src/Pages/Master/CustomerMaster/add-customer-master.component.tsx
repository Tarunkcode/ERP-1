...
import { MasterApiContext } from '../../../AppContext/master.context';
...
// HOC 
export function lookIntoContext(Component : any) {
    const anyProps = ({ props }: any) => {

        var { seriesMasterData, delMasterData, payMasterData, customerMasterData} = React.useContext(MasterApiContext);
        
        return <Component {...props} apiSeries={seriesMasterData} apiDelTerms={delMasterData} apiPayTerms={payMasterData} apiCustomerGp={customerMasterData} />;
...
class ApiState extends React.Component<IProps, IState> {
    ...
    render() {
        var { apiSeries, apiDelTerms, apiPayTerms, apiCustomerGp} = this.props;
        return (
            <>
                            ...
                            <fieldset className="form-group border p-0" >
                                ...
                                <div className="show" id="genDetails">
                                    <span className="d-flex section2 col-sm-12">
                                        <>
                                            <CustomInput name="series" ipType="text" label="Series" ipTitle="Enter Series" dataArray={apiSeries} />
                                    ...
                                    <span className="d-flex section2 col-sm-12">
                                        ...
                                        <>
                                            ...
                                            <CustomInput name="custGrp" ipType="text" label="Customer Group" ipTitle="Enter Customer Group" dataArray={apiCustomerGp} />
                                            <CustomerGroupModal />
                                    ...
                                    <span className="d-flex section2 col-sm-12">
                                        ...
                                        <>
                                            ...
                                            <CustomInput name="delTerms" ipType="text" label="Delivery Terms" ipTitle="Enter Delievery Terms" dataArray={apiDelTerms} />
                                            <DelTermsModal />
                                        </>

                                        <>

                                            <CustomInput name="payTerms" ipType="text" label="Payment terms" ipTitle="Enter Payment Terms" dataArray={apiPayTerms} />
                                            <PayTermsModal />
                                        </>
...
const AddCustomerMaster = lookIntoContext(ApiState);

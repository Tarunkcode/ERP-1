                            ...
                            <fieldset className="form-group border p-0" >
                                ...
                                <div className="collapse show" id="genDetails">
                                    ...
                                    <span className="d-flex justify-content-space-evenly flex-row section2 col-sm-12">
                                        ...
                                        <MasterInput2 name="codestr" defaultt={defItemDetails ? defItemDetails.codestr : ''} label="Code" ipTitle="Enter Code" ipType="text" handleChange={handleChangeField} classCategory="form-control col-12 str" length={20 } />
                                    </span>


                                    <span className="d-flex flex-row section2 col-sm-12">
                                        <MasterInput2 name="name" label="Name" defaultt={defItemDetails ? defItemDetails.name : ''} ipTitle="Enter Name" ipType="text" handleChange={handleChangeField} classCategory="form-control col-12 " length={60}/>
                                        <span className="col-1 m-0"></span>

                                        <MasterInput2 name="printname" label="Print Name" defaultt={defItemDetails ? defItemDetails.printname : ''} ipTitle="Enter Print Name" ipType="text" handleChange={handleChangeField} classCategory="form-control col-12" length={60 } />

...
function SalePurchaseType_Page(_a) {
    var defGstCatName = _a.defGstCatName, vccode = _a.vccode, defaultLoad = _a.defaultLoad, handleChange = _a.handleChange, handlePosting = _a.handlePosting, pageTitle = _a.pageTitle, getMasterType = _a.getMasterType, configType = _a.configType, SelectList = _a.SelectList, gstCat = _a.gstCat, billSundry = _a.billSundry, getTableData = _a.getTableData, otherProps = __rest(_a, ["defGstCatName", "vccode", "defaultLoad", "handleChange", "handlePosting", "pageTitle", "getMasterType", "configType", "SelectList", "gstCat", "billSundry", "getTableData"]);
        ...
        React.createElement("div", { className: "main card firstDiv" },
            ...
            React.createElement("form", { className: "row-content form col-sm-12 pt-0" },
                ...
                React.createElement("span", { className: "d-flex section2 col-sm-12" },
                    ...
                    React.createElement("span", { className: "col-4 m-0 p-0", style: { width: '100%' } },
                        React.createElement(react_datalist_input_1.default, { value: defGstCatName, className: "d-flex col-12 m-0 p-0", inputProps: { className: 'form-control inp  datalist col-12  seriesConf', name: 'gstcat' }, listboxProps: { className: 'text-left mt-5' }, onSelect: function (item) { return SelectList(item); }, items: gstCat })),
                    React.createElement("span", { className: "col-1 m-0" }),
                    React.createElement(custom_switch_component_1.CustomeSwitch2, { default: defaultLoad.sptypeheader ? defaultLoad.sptypeheader[0].gstenable : '', lablClass: "custom-control-label col-8", label: "GST Enable", id: "gstenable", name: "gstenable", classCat: "form-control custom-control-input col-3 seriesConf switch", handleChange: handleChange })),
                React.createElement("span", { className: "d-flex section2 col-sm-12" },
                    ...
                    React.createElement("span", { className: "col-1 m-0" }),
                    React.createElement(custom_switch_component_1.CustomeSwitch2, { default: defaultLoad.sptypeheader ? defaultLoad.sptypeheader[0].itemwisetax : '', lablClass: "custom-control-label col-8", label: "Enable Item Wise Tax", id: "itemwisetax", name: "itemwisetax", classCat: "form-control custom-control-input col-3 seriesConf switch", handleChange: handleChange })),
                React.createElement("span", { className: "d-flex section2 col-sm-12" },
                    React.createElement(custom_input_component_1.MasterInput3, { default: defaultLoad.sptypeheader ? defaultLoad.sptypeheader[0].branchcode : '', handleChange: handleChange, name: "branchcode", classCategory: "form-control inp col-4  seriesConf select", ipType: "text", label: "Branch Code", ipTitle: "Enter Branch Code" }),
                    React.createElement("span", { className: "col-1 m-0" }),
                    React.createElement("span", { className: "col-4 m-0" })))),

...
const PurcahseQuotation = () => {
    ...
    var ColDef: any[] = [{ field: 'srno', headerName: 'S.No.', minWidth: 100, valueGetter: 'node.rowIndex + 1' },
        ...
        { field: 'prnumber', headerName: 'PR Number', minWidth: 200 },
        { field: 'line', headerName: 'Line No', minWidth: 200, editable: true },
        ...
        { field: 'qq', headerName: 'Quotation Qty', minWidth: 200, editable: true },
        { field: 'unit', headerName: 'Unit', minWidth: 200, editable: true },
        { field: 'reqd', headerName: 'Req.Days', minWidth: 200, editable: true },
        ...
        <>
            <div className="main card firstDiv">
                        ...
                        <fieldset className="form-group border p-0" >
                            ...
                            <div className="collapse show" id="genDetails">
                                ...
                                <span className="d-flex section2 col-sm-12">
                                    ...
                                    <MasterInput2 name="majProd" label="PR From Date" ipTitle="Enter PR From Date" ipType="date" classCategory="form-control col-4 inp" />
                                </span>

                                <span className="d-flex section2 col-sm-12">
                                    <MasterInput2 name="prto-date" label="PR To Date" ipTitle="Enter PR To Date" ipType="date" classCategory="form-control col-4 inp" />
                                    <span className="col-1 m-0"></span>

                                    <MasterInput2 name="pr-no" label="PR No. From" ipTitle="Enter PR No. From" ipType="date" classCategory="form-control col-4 inp" />
                                </span>
                            ...
                            <button type="button" style={{ border: '2px solid ', letterSpacing: 3, width: '200px', borderRadius: '19px' }} onClick={() => { }} className="btn mr-2 ml-2 btn-secondary mt-2 mb-2 pl-0 pr-0 ">Load PR</button>
                                </span>
                              

                            </div>
                           {/* <button type="submit" className="btn btn-primary m-2">Load PR</button>*/}
                        </fieldset>
                    </form>
                    <hr style={{ margin: '0', padding: '0' }} />
                    <div className="row card row-content col-sm-12 addSaleForm container container-fluid container-lg mb-3">
                        <WriteGrid title="Quotation Details" w='100vw' titleClr="blue" OpenSubLayer={() => { }} colDef={ColDef} data={data} />
                ...
                <hr style={{ margin: '0', padding: '0' }} />
                    ...
                    <span className="d-flex section2 col-sm-12">
                        <MasterInput2 name="quotationser" label="Quotation Series" ipTitle="Enter Quotation Series" ipType="text" classCategory="form-control col-4 inp" />
                        <span className="col-1 m-0"></span>
            ...
            <div className="btn-group col-12 mt-3" style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
                ...
                <button type="button" style={{ border: '2px solid orange', letterSpacing: 3 }} className="btn btn-warning pl-0 pr-0 col-3">Quit</button>
            </div>
        </>
    )
}

export default PurcahseQuotation;
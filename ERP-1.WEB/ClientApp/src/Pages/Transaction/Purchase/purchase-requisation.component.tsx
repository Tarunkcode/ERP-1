        ...
        <>
            <div className="main card firstDiv">
                ...
                <div className="text-center card-title col-12" style={{ textAlign: 'start', backgroundColor: '#8389d4' }}>
                    <span className="row-header p-0 m-0" >Manual Purchase Requisation</span>
                </div>
                        ...
                        <fieldset className="form-group border p-0" >
                            ...
                            <div className="collapse show" id="genDetails">
                                <span className="d-flex section2 col-sm-10">
                                    <>
                                        <label htmlFor="series" style={{ fontSize: '0.8em' }} className="form-label labl labl2">PR Type</label>
                                ...
                                <span className="d-flex section2 col-sm-10">
                                    <>
                                        <label htmlFor="majProd" style={{ fontSize: '0.8em' }} className="form-label labl labl2">PR. Date</label>
                                        <input type="date" name="payTerm" className="form-control inp" />
                                    </>
                                    <>
                                        <label htmlFor="series" style={{ fontSize: '0.8em' }} className="form-label labl labl2">Department</label>
                                ...
                                <span className="d-flex section2 col-sm-10">
                                    <>
                                        ...
                                        <textarea  name="custName" className="form-control col-sm-6 inp" />
                                    </>

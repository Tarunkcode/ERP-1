                        ...
                        <fieldset className="form-group border p-0" >
                            ...
                            <div className="collapse show" id="genDetails">
                                <span className="d-flex section2 col-sm-10">
                                    ...
                                    <>
                                        <label htmlFor="majProd" style={{ fontSize: '0.8em' }} className="form-label labl labl2">Cancel Dispatch</label>
                                        <input type="checkbox" name="payTerm" className="inp" />
                                    </>
                                </span>
                                ...
                                <span className="d-flex section2 col-sm-10">
                                    <>
                                        <label htmlFor="series" style={{ fontSize: '0.8em' }} className="form-label labl labl2">Customer</label>
                                        <input type="text" name="custName" className="form-control inp" />
                                    </>
                                    <>
                    ...
                    <div className="row card row-content col-sm-12 addSaleForm container container-fluid container-lg mb-3">
                        <div className="card-body col-sm-12 addCustomer container container-fluid container-lg" style={{ overflowX: 'auto', overflowY: 'auto' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', borderBottom: '1px solid grey', backgroundColor: '#8389d4', margin: '0', padding: '0', width: '100%' }}>
                                <span className="card-title" style={{ fontSize: '15px', margin: '0', padding: '0' }}>D.S Customer Item Details</span>
                            </div>
                            <table id="dtHorizontalExample" className="table table-striped table-bordered table-sm" style={{
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th className="text-center" style={{ fontWeight: 400, backgroundColor: 'grey', color: 'white' }}>SO. No.</th>
                                        <th className="text-center" style={{ fontWeight: 400, backgroundColor: 'grey', color: 'white' }}>Cust.Po.No.</th>
                                        <th className="text-center" style={{ fontWeight: 400, backgroundColor: 'grey', color: 'white' }}>PO Date</th>
                                        <th className="text-center" style={{ fontWeight: 400, backgroundColor: 'grey', color: 'white' }}>Bal.Aty</th>
                                        ...
                                        <th className="text-center" style={{ fontWeight: 400, backgroundColor: 'grey', color: 'white' }}>Alt.Qty</th>

    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "main card firstDiv" },
            React.createElement("div", { className: "text-center card-title col-12", style: { textAlign: 'start', backgroundColor: '#8389d4' } },
                React.createElement("span", { className: "row-header p-0 m-0" }, "Quotation From Sale")),
                ...
                React.createElement("form", { className: "row-content form col-sm-12 pt-0" },
                    React.createElement("fieldset", { className: "form-group border p-0" },
                        ...
                        React.createElement("div", { className: "collapse show", id: "genDetails" },
                            ...
                            React.createElement("span", { className: "d-flex section2 col-sm-10" },
                                React.createElement(React.Fragment, null,
                                    React.createElement("label", { htmlFor: "majProd", style: { fontSize: '0.8em' }, className: "form-label labl labl2" }, "Sale From Date"),
                                    React.createElement("input", { type: "date", name: "payTerm", className: "form-control inp" })),
                                React.createElement(React.Fragment, null,
                                    React.createElement("label", { htmlFor: "series", style: { fontSize: '0.8em' }, className: "form-label labl labl2" }, "Sale To Date"),
                            ...
                            React.createElement("span", { className: "d-flex section2 col-sm-10" },
                                React.createElement(React.Fragment, null,
                                    ...
                                    React.createElement("input", { type: "text", name: "custName", className: "form-control inp" })))),
                        React.createElement("button", { type: "submit", className: "btn btn-primary m-2" }, "Load Sale"))),
...
exports.default = SaleQuotaton;
//# sourceMappingURL=sales-quotation.component.js.map
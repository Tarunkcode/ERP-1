...
const Daily_Plan_Print = () => {
    //-------------------------------------------------------------------------------------------------------------------------------------------------------------

    let data: any[] = [{ pno: null, pdate: null, ic: null, in: null, pqty: null, prodqty: null, balqty: null, uom: null, pmachine: null, plnhrs: null }]
    ...
    var ColDef: any[] = [
        ...
        { field: 'pqty', headerName: 'Plan Qty', minWidth: 200 },
        ...
        { field: 'pmachine', headerName: 'Plan Machine', minWidth: 200 },
        { field: 'planhrs', headerName: 'Plan Hrs', minWidth: 200 },

    ]

    let datad: any[] = [{ ic: null, in: null, reqty: null, uom: null}]
        ...
        <>
            <div className="main card firstDiv">
                ...
                <div className="text-center card-title col-12" style={{ textAlign: 'start', color: 'white' }}>
                    <span className="row-header p-0 m-0" >Daily Plan Print</span>
                </div>
...
export default Daily_Plan_Print;
...
const Challan_Receipt_Party = () => {
    ...
    { field: 'cqty', headerName: 'Challan Qty.', minWidth: 200, editable: true },
    { field: 'bqty', headerName: 'Bal. Qty', minWidth: 200, editable: true },
    { field: 'uom', headerName: 'UOM', minWidth: 200, editable: true },
    { field: 'jwr', headerName: 'JW Rate', minWidth: 200, editable: true },
    { field: 'jwv', headerName: 'JW Value', minWidth: 200, editable: true },
    { field: 'price', headerName: 'Price', minWidth: 200, editable: true },
    { field: 'value', headerName: 'Value', minWidth: 200, editable: true },
    { field: 'cno', headerName: 'Challan No.', minWidth: 200, editable: true },
    { field: 'gstc', headerName: 'Rec. Weight(KG)', minWidth: 200, editable: true },
            ...
            <div className="row row-content col-sm-12 addSaleForm container container-fluid container-lg">
                <div className="row row-content col-sm-12" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#8389d4', margin: '0', padding: '0' }}>
                    ...
                    <span className="card-title" style={{
                        ...
                        margin: '0'
                    }}>Challan Receipt From Party</span>
                        ...
                        <form className="row-content form col-sm-12 pt-0">
                            <fieldset className="form-group border p-0" >
                                ...
                                <span className="d-flex section2 col-sm-12">
                                 ...
                                 <span className="d-flex section2 col-sm-12">
                                    <MasterInput2 name="pono" label="Po No." ipTitle="Enter Po No." ipType="text" classCategory="form-control col-4 inp" />
                                    <span className="col-1 m-0"></span>
                        ...
                        <fieldset className="form-group border p-0" >
                            ...
                            <div className="collapse" id="tdetails">
                                ...
                                <span className="d-flex section2 col-sm-12">
                                    ...
                                    <span className="col-1 m-0"></span>
                                    <MasterInput2 name="refno" label="Ref No." ipTitle="Enter Way From No." ipType="text" classCategory="form-control col-4 inp" />
                                </span>

                                  <span className="d-flex section2 col-sm-12">
                                    <MasterInput2 name="gateentryno" label="Gate Entry No." ipTitle="Enter Gate Entry No." ipType="text" classCategory="form-control col-4 inp" />

                                    <span className="col-1 m-0"></span>
                                    <MasterInput2 name="bill" label="Bill No." ipTitle="Enter Bill No" ipType="text" classCategory="form-control col-4 inp" />
                                </span>
...
export default Challan_Receipt_Party;
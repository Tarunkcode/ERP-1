...
import './Pending-Pur-Details.styles.css'
...
function PendingPurchaseDetails() {
    ...
    }, [changeItem, changeItemGroup, changeParty, changeSeries, changeEndDate, changeStartDate])
    ...
    const sendRequest = React.useCallback(async () => {
        ...
        try {
            var GetPODetails = `http://${window.location.host}/api/GetPendingPurchaseOrderDetails`
        ...
        if (isMounted.current) // only update if we are still mounted
            setIsSending(false)
    }, [isSending, changeItem, changeItemGroup,changeParty,changeEndDate, changeStartDate]) // update the callback if the state changes
        ...
        <div className="firstDiv">
            <div className="container col-sm-12 card" style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "bottom", margin: "0 auto" }}>
                <div className="card-title col-12 text-center" style={{ margin: '0 auto' }}>
                    <span style={{ fontSize: "20px" }}>Pending Purchase Details Report</span>
                </div>
                        ...
                        <ExcelExport data={dataArray} ref={_export}>
                            ...
                            <div style={{ display: 'none', border: '3px solid green' }}>
                                <Grid data={dataArray} style={{ height: "420px" }}>
                                    ...
                                    <GridColumn field="supplierName" title="Supplier Name" />
                                    <GridColumn field="poDate" title="Po. Date" />
                                   
                                    <GridColumn field="itemCode" title="Item Code" />
                                    <GridColumn field="itemName" title="Item Name" />
                                    <GridColumn field="price" title="Price" />
                                   
                                    <GridColumn field="qty" title="Quantity" />
                                    <GridColumn field="uom" title="UOM" />
                                    <GridColumn field="val" title="Value" />
                                    <GridColumn field="grQty" title="Gr. Qty" />
                                    <GridColumn field="pendQty" title="Pending Qty" />
                                    <GridColumn field="delDate" title="Del Date" />
                                    <GridColumn field="openClose" title="openClose" />
                                    ...
                                    <table  className="table table-striped table-bordered table-hover table-sm">
                                        <thead className="thead-light table-secondary">
                                            <tr>
                                                ...
                                                <th style={{ padding: "0", margin: '0', backgroundColor: 'grey', position: 'sticky' }} scope="col"><span style={{ margin: '33px', fontWeight: 400, fontSize: '15px', color: 'white' }}>Price</span></th>
                                                <th style={{ padding: "0", margin: '0', backgroundColor: 'grey', position: 'sticky' }} scope="col"><span style={{ margin: '33px', fontWeight: 400, fontSize: '15px', color: 'white' }}>Quantity</span></th>
                                                ...
                                                <th style={{ padding: "0", margin: '0', backgroundColor: 'grey', position: 'sticky' }} scope="col"><span style={{ margin: '33px', fontWeight: 400, fontSize: '15px', color: 'white' }}>RecieveQty.</span></th>
                                                ...
                                                <th style={{ padding: "0", margin: '0', backgroundColor: 'grey', position: 'sticky' }} scope="col"><span style={{ margin: '33px', fontWeight: 400, fontSize: '15px', color: 'white' }}>Del.Date</span></th>
                                                <th style={{ padding: "0", margin: '0', backgroundColor: 'grey', position: 'sticky' }} scope="col"><span style={{ margin: '33px', fontWeight: 400, fontSize: '15px', color: 'white' }}>OpenClose</span></th>
